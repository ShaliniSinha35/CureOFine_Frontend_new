...
const IVF = ({ navigation }) => {
    ...
    const getIvfList = async () => {
        const res = await axios.get("https://cureofine.com/api/api/ivf")
        const data = res.data;
        setIvfList(data)
    }
...
<Image style={{width:100,height:100,resizeMode:"contain"}} source={{ uri: `https://cureofine.com/upload/ivfcat/${item.image}` }} />
</View>
