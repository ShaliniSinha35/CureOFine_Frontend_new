...
const DentalInnerScreen = ({ navigation }) => {
    ...
    const getSurgeryList = async () => {
        ...
        const res = await axios.get("https://cureofine.com/api/api/dentalList", {
            params: {
    ...
    return (
        <View style={{ backgroundColor: "white", height: "100%" }}>
            ...
            <ScrollView>
                ...
                <Text allowFontScaling={false}  style={{ color: "black", padding: 15, fontSize: 15, paddingBottom: 2 }}>
                    Elevate Your Healthcare Experience -
                </Text>
                <Text allowFontScaling={false}  style={{ color: "#eb3b5a", paddingLeft: 12, fontSize: 12 }}>
                    Explore a Range of Premium Medical Services on our App.
                </Text>
                <View style={{ height: 1, borderColor: "whitesmoke", borderWidth: 2, marginTop: 15 }} />
                ...
                <View style={{ marginTop: 20, paddingBottom: 50 }}>
                    {surgery === "" ? (
                        ...
                        <View style={{ flex: 1 }}>
                            <Text allowFontScaling={false}  style={{ fontSize: 18, color: "#103042", fontWeight: "500", marginLeft: 20 }}>
                                {route.params.name} Hospitals
                            </Text>
                            {surgery.map((item) => (
                                        ...
                                        <FlatList
                                            ...
                                            renderItem={({ item: hos }) => (
                                                <Image
                                                    ...
                                                    style={{ height: 150, width: 300, resizeMode: "contain", marginBottom: 5 }}
                                                />
                                            )}
                                        />
                                    </View>
                                    <View style={{ marginLeft: 0, marginTop: 0, flex: 1 }}>
                                        <Card.Content>
                                                ...
                                                {item.facilityArr &&
                                                    item.facilityArr.map((facility) => (
                                                        ...
                                                        >
                                                            ...
                                                            <Text allowFontScaling={false}  style={{ color: "#f46b78", fontSize: 12, marginLeft: 2 }}>
                                                                {facility.name}
                                                            </Text>
                                                        </View>
                                                    ))}
                                            ...
                                            <Text allowFontScaling={false} style={{ marginTop: 10, fontWeight: 700, fontSize: 16 }}>
                                                Treatment Price: <FontAwesome name="rupee" size={14} color="#103042" />{" "}
                                                {item.display_price}
                                            </Text>
